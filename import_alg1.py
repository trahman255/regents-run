...
def import_alg1():
    ...
    with open('algi.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
            
    # SQL to include the new image_urls and explanation columns
    query = text("""
    ...
    db.commit()
    db.close()
    print(f"Successfully imported {count} Algebra I questions with explanations!")
